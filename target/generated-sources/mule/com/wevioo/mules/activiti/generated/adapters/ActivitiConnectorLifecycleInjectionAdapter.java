...
/**
 * A <code>ActivitiConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link ActivitiConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-05-24T03:42:50+01:00", comments = "Build UNNAMED.2793.f49b6c7")
public class ActivitiConnectorLifecycleInjectionAdapter
    extends ActivitiConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(ActivitiConnectorLifecycleInjectionAdapter.class);
