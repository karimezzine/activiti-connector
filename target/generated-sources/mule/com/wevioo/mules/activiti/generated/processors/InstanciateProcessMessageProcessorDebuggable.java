...
public class InstanciateProcessMessageProcessorDebuggable
    extends InstanciateProcessMessageProcessor
    implements DebugInfoProvider
{


    public InstanciateProcessMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("processDefinitionName", "Process definition name", (java.lang.String.class), processDefinitionName, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("map", "Data", (java.util.Map.class), map, muleEvent));
