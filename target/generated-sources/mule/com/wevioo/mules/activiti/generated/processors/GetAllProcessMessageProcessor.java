...
/**
 * GetAllProcessMessageProcessor invokes the {@link com.wevioo.mules.activiti.ActivitiConnector#getAllProcess()} method in {@link ActivitiConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-05-24T03:42:50+01:00", comments = "Build UNNAMED.2793.f49b6c7")
public class GetAllProcessMessageProcessor
    extends DevkitBasedMessageProcessor
    implements MessageProcessor, OperationMetaDataEnabled
{


    public GetAllProcessMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((ActivitiConnector) object).getAllProcess();
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at ActivitiConnector at getAllProcess retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
