...
public class CompleteTaskMessageProcessorDebuggable
    extends CompleteTaskMessageProcessor
    implements DebugInfoProvider
{


    public CompleteTaskMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("taskId", "Task id", (java.lang.String.class), taskId, muleEvent));
