...
public class GetCurrentTaskMessageProcessorDebuggable
    extends GetCurrentTaskMessageProcessor
    implements DebugInfoProvider
{


    public GetCurrentTaskMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("processInstanceId", "Process instance id", (java.lang.String.class), processInstanceId, muleEvent));
